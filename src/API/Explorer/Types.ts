...
export enum BidOfferSort {
  Created = "created",
  Updated = "updated",
  BidOfferId = "bidoffer_id",
  Price = "price",
  TemplateMint = "template_mint",
  SchemaMint = "schema_mint",
...
export interface BidOfferParams extends SearchParams {
  account?: string[];
  sender?: string[];
  buyer?: string[];
  state?: BidOfferState[];
...
export interface ListingBidOffer {
  contract: string;
  offer_id: string;
  sender_name: string;
  recipient_name: string;
